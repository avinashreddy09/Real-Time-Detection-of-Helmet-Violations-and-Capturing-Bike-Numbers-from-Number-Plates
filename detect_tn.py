...
# Video path - CHANGE THIS TO tn.mp4
video_path = r"C:\Users\avina\Downloads\tn.mp4"
output_path = "tn_output.mp4"
...
print("Processing tn.mp4 with plate detection...")
print("-" * 50)
...
if detected_plates:
    ...
    print("  No number plates were detected in tn.mp4")
print("-" * 40)